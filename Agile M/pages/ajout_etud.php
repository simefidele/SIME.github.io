...
<head>
    ...
    <?php
         ...
         if(isset($_POST['submit1'])){
            $matricule_etd=$_POST['matricule_etd'];
            $nom_etd=$_POST['nom_etd'];
            $id_salle=$_POST['id_salle'];
            $password_n=$_POST['password'];
            $password = password_hash($password_n, PASSWORD_DEFAULT);
            $re="INSERT INTO etudiant (matricule_etd, nom_etd, id_salle, password_etd) VALUES ('$matricule_etd','$nom_etd','$id_salle', '$password')";
...
<body onload="remplit()">
    ...
    <div id="main">
        ...
        <form id="myForm" action="ajout_etud.php" method="post">
            <div id="nav2">
                <div id="log_in"><a href="admi.html">back</a></div>
            </div>

            <div id="main_home">
                <div id="img"><h1>ajouter un etudiant</h1></div>
                <table>
                    <tr>
                        <th colspan=2>Ajout d'un etudiant</th>
                    </tr>
                    <tr>
                        <th>Matricule</th>
                        <td><input type="text" name="matricule_etd" ></td>
                    </tr>
                    <tr>
                        <th>Nom complet</th>
                        <td><input type="text" name="nom_etd" ></td>
                    </tr>
                    <tr>
                        <th>Mot de passe</th>
                ...
                <table>
                    <tr>
                        <th colspan="3">Liste des etudiants</th>
                    </tr>
                    <tr>
                        <th>Matricule</th>
                        <th>Nom</th>
                    ...
                    <?php 
                        ...
                        while($resultat3=$req->fetch_assoc()){
                            echo "<tr>";
                            echo "<td align='center' class='td'>",$resultat3['matricule_etd'],"</td>";
                            echo "<td align='center' class='td'>",$resultat3['nom_etd'],"</td>";
